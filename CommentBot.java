...
public class CommentBot {
    ...
    public static void main(String... args) throws Exception {
        CommentBot keyboard = new CommentBot();
        // IMPORTANT: Only edit the below line
        String[] wordlist = {"insert", "your", "messages", "here"};
    ...
    public CommentBot() throws AWTException {
        this.robot = new Robot();
    }

    public CommentBot(Robot robot) {
        this.robot = robot;
    }
